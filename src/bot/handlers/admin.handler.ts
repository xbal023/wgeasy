...
// Simple state tracking for admin actions (works with webhooks)
...
export const registerAdminHandler = (bot: Bot<MyContext>) => {
  ...
  // ═══════════════════════════════════════
  // ─── BROADCAST (state-based, no conversations) ───
  // ═══════════════════════════════════════
  ...
  // ═══════════════════════════════════════
  // ─── TEXT MESSAGE HANDLER (for state-based input) ───
  // ═══════════════════════════════════════
